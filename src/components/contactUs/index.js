        ...
        <div className="contact-card-box py-12 px-6 md:p-12">
          ...
          <div className="contact-right-content">
            ...
            <div className="find-flx-bx">
              <Image src="/images/wtsup-logo.png" alt="wtsup" width={40} height={40} />
              <p className="find-sub-heading">+12 3456 7890</p>
            </div>
            <div className="find-flx-bx">
              <Image src="/images/telegram-logo.png" alt="telegram" width={40} height={40} />
              <p className="find-sub-heading">telegram@something</p>
            </div>
            <div className="find-flx-bx">
              <Image src="/images/email-logo.png" alt="email" width={40} height={40} />
